...
def checkout():
    ...
    if request.method == "POST":
        ...
        db.execute("INSERT INTO checkout(user_id, full_name, email, phone_number, address, province, zip_code, payment_method) VALUES(:user_id, :full_name, :email, :phone_number, adress, :province, :zip_code, :payment_method",
